...
SimEnvironment::SimEnvironment() {
    ...
    local_env["TRICK_CFLAGS"] = "  -g  -O0 -g -Imodels";
    ...
    local_env["TRICK_CXXFLAGS"] = "  -g  -O0 -g -Imodels";
    ...
    local_env["TRICK_EXEC_LINK_LIBS"] = " -L/usr/lib/python3.10/config-3.10-x86_64-linux-gnu -L/usr/lib/x86_64-linux-gnu -lpython3.10 -lcrypt -ldl  -lm -lm  -lpython3.10 -lcrypt -ldl  -lm -lm    -ludunits2 -lrt -lm -ldl";
    ...
    local_env["TRICK_HOME"] = "/home/fjolnirr/trick";
    setenv("TRICK_HOME", local_env["TRICK_HOME"].c_str(), 0);
    local_env["TRICK_HOST_CPU"] = "Linux_11.4_x86_64";
    ...
    local_env["TRICK_SYSTEM_CFLAGS"] = "-isystem/home/fjolnirr/trick/trick_source -isystem/home/fjolnirr/trick/include -isystem/home/fjolnirr/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=7 -fpic  -DUSE_ER7_UTILS_INTEGRATORS -fexceptions";
    setenv("TRICK_SYSTEM_CFLAGS", local_env["TRICK_SYSTEM_CFLAGS"].c_str(), 0);
    local_env["TRICK_SYSTEM_CXXFLAGS"] = "-isystem/home/fjolnirr/trick/trick_source -isystem/home/fjolnirr/trick/include -isystem/home/fjolnirr/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=7 -fpic  -DUSE_ER7_UTILS_INTEGRATORS";
    setenv("TRICK_SYSTEM_CXXFLAGS", local_env["TRICK_SYSTEM_CXXFLAGS"].c_str(), 0);
    local_env["TRICK_SYSTEM_LDFLAGS"] = "  -O0 -g  -O0 -g -Wl,--export-dynamic";
    setenv("TRICK_SYSTEM_LDFLAGS", local_env["TRICK_SYSTEM_LDFLAGS"].c_str(), 0);
    local_env["TRICK_USER_CSHRC"] = "/home/fjolnirr/.Trick_user_cshrc";
    setenv("TRICK_USER_CSHRC", local_env["TRICK_USER_CSHRC"].c_str(), 0);
    local_env["TRICK_USER_HOME"] = "/home/fjolnirr/trick_sims";
    ...
    local_env["TRICK_USER_PROFILE"] = "/home/fjolnirr/.Trick_user_profile";
    ...
    local_env["XML_CATALOG_FILES"] = "/home/fjolnirr/trick/libexec/trick_source/data_products/DPX/XML/catalog.xml";
