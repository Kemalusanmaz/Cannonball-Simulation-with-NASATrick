...
#define SWIGTYPE_p_CANNONFAILURE swig_types[1]
...
/*-----------------------------------------------
              @(target):= _ma750df08e2d9fd33879d7d7313be3144.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__ma750df08e2d9fd33879d7d7313be3144

#else
#  define SWIG_init    init_ma750df08e2d9fd33879d7d7313be3144

#endif
#define SWIG_name    "_ma750df08e2d9fd33879d7d7313be3144"
...
SWIGINTERN PyObject *_wrap_cannon_step_wrapper(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  CANNON *arg1 = (CANNON *) 0 ;
  CANNONFAILURE *arg2 = (CANNONFAILURE *) 0 ;
  InputHeightValue *arg3 = (InputHeightValue *) 0 ;
  PyObject *swig_obj[3] ;
  
  if (!SWIG_Python_UnpackTuple(args, "cannon_step_wrapper", 3, 3, swig_obj)) SWIG_fail;
  {
    // CANNON *
    void * temp_ptr ;
  ...
  }
  {
    ...
    if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[2], &temp_ptr,SWIGTYPE_p_InputHeightValue, SWIG_POINTER_DISOWN)) ) {
      arg3 = reinterpret_cast< InputHeightValue * >(temp_ptr) ;
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[2], &temp_ptr,SWIG_TypeQuery("_p_swig_ref"), 0)) ) {
      // Array to pointer assignment
      swig_ref * temp_swig_ref = reinterpret_cast< swig_ref * >(temp_ptr);
      if ( temp_swig_ref != NULL ) {
        arg3 = reinterpret_cast< InputHeightValue * >(temp_swig_ref->ref.address) ;
      }
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[2], &temp_ptr,SWIG_TypeQuery("_p_REF2"), 0)) ) {
      // We have an address coming in, we don't have to do any translation
      REF2 * temp_ref = reinterpret_cast< REF2 * >(temp_ptr) ;
      if ( temp_ref != NULL ){
        arg3 = reinterpret_cast< InputHeightValue * >(temp_ref->address) ;
      }
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[2], &temp_ptr,SWIG_TypeQuery("_p_void"), 0)) ) {
      // We have an address coming in, we don't have to do any translation
      arg3 = reinterpret_cast< InputHeightValue * >(temp_ptr) ;
    }
  }
  cannon_step_wrapper(arg1,arg2,arg3);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_cannon_init_wrapper(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  CANNON *arg1 = (CANNON *) 0 ;
  CANNONFAILURE *arg2 = (CANNONFAILURE *) 0 ;
  PyObject *swig_obj[2] ;
  
  if (!SWIG_Python_UnpackTuple(args, "cannon_init_wrapper", 2, 2, swig_obj)) SWIG_fail;
  {
    // CANNON *
    void * temp_ptr ;
...
SWIGINTERN PyObject *_wrap_cannon_default_FDIR(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_cannon_init_FDIR(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  CANNON *arg1 = (CANNON *) 0 ;
  CANNONFAILURE *arg2 = (CANNONFAILURE *) 0 ;
  PyObject *swig_obj[2] ;
  
  if (!SWIG_Python_UnpackTuple(args, "cannon_init_FDIR", 2, 2, swig_obj)) SWIG_fail;
  {
    // CANNON *
    void * temp_ptr ;
...
SWIGINTERN PyObject *_wrap_cannon_step_FDIR(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  CANNON *arg1 = (CANNON *) 0 ;
  CANNONFAILURE *arg2 = (CANNONFAILURE *) 0 ;
  InputHeightValue *arg3 = (InputHeightValue *) 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "cannon_step_FDIR", 3, 3, swig_obj)) SWIG_fail;
  {
    // CANNON *
    void * temp_ptr ;
  ...
  cannon_step_FDIR(arg1,arg2,arg3);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "cannon_step_wrapper", _wrap_cannon_step_wrapper, METH_VARARGS, NULL},
	 { "cannon_init_wrapper", _wrap_cannon_init_wrapper, METH_VARARGS, NULL},
	 { "cannon_default_FDIR", _wrap_cannon_default_FDIR, METH_O, NULL},
	 { "cannon_init_FDIR", _wrap_cannon_init_FDIR, METH_VARARGS, NULL},
	 { "cannon_step_FDIR", _wrap_cannon_step_FDIR, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
